...
const Navbar = ({ toggleMenu, isOpen, isOpen1  }) => {
        ...
        <div>
            <div className="relative">
                ...
                <div className="absolute inset-0">
                    <div className="relative">
                        <div className="absolute left-5 md:left-36 top-7">
                        ...
                        <div className="hidden md:block absolute top-11 right-24 text-white">
                            <ul className="text-lg font-Commissioner flex gap-4 ">
                                <li className="">About</li><hr/>
                                <li className="">Discover</li><hr/>
