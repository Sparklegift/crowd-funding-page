const Thankscard = () => {
    return ( 
        <div className="w-10/12 bg-white font-Commissioner rounded-md p-4 grid gap-7 pt-9 pb-9">
            <div className="flex justify-center">
            <img src="/image/icon-check.svg" />
            </div>
            <h1 className="text-center font-extrabold">Thanks for your support!</h1>
